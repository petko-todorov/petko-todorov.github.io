    ...
    return (
        ...
        >
            <div
                ...
                className="mx-auto mt-0 flex flex-col fixed top-20 right-32 w-[90%] max-w-md h-[500px] bg-white rounded-3xl shadow-lg z-50 max-lg:top-13 max-lg:bottom-0 max-lg:left-0 max-lg:right-0"
            >
